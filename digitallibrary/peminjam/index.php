						...
						<div class="card">
							<div class="card-body bg-primary bg-gradient bg-opacity-75 text-center">
                                ...
                                printf($rowcount);
                                 ...
                                 ?></b></h3>
								<hr>
								<a href="tampil_buku.php" class="btn btn-outline-dark">Lihat Daftar Buku</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3">
						<div class="card">
							<div class="card-body bg-primary bg-gradient bg-opacity-75 text-center">
								...
								<hr>
								<a href="kategoribuku.php" class="btn btn-outline-dark">Lihat Daftar Kategori</a>
                            </div>
                        </div>
                    </div>
					<div class="col-sm-3">
						<div class="card">
							<div class="card-body bg-primary bg-gradient bg-opacity-75 text-center">
                                ...
                                <hr>
								<a href="tampil_pengguna.php" class="btn btn-outline-dark">Lihat Data</a>
                            </div>
                        </div>
                    </div>
					<div class="col-sm-3">
						<div class="card">
							<div class="card-body bg-primary bg-gradient bg-opacity-75 text-center">
								...
								<hr>
								<a href="http://localhost/digitallibrary/peminjam/form_peminjaman.php/" class="btn btn-outline-dark">Mau Pinjam!</a>
                            </div>
                        </div>
                    </div>
		        </div>
