					...
					<div class="col-sm-3">
						<div class="card">
							<div class="card-body bg-primary bg-gradient bg-opacity-75 text-center">
                                ...
                                <hr>
								<a href="../admin/tampil_pengguna.php" class="btn btn-outline-dark">lihat data</a>
                            </div>
                        </div>
                    </div>
					<div class="col-sm-3">
						<div class="card">
							<div class="card-body bg-primary bg-gradient bg-opacity-75 text-center">
								...
								<hr>
								<a href="http://localhost/digitallibrary/admin/laporan_peminjaman.php/" class="btn btn-outline-dark">lihat data</a>
                            </div>
                        </div>
                    </div>
		        </div>
